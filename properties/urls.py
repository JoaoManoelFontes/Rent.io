...
from .views.forms import apartment_form, building_form, contract_form, delete_expense, delete_payment, delete_property, expense_form, house_form, payment_form, delete_contract
